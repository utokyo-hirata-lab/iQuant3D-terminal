...
class iq3t():
    ...
    def finishing(self):
        ...
        if os.name == 'posix':
            ...
            os.system('move '+self.folder+'\*.xlsx '+self.folder+'/result')
            print('move '+self.folder+'\*.xlsx '+self.folder+'/result')
            print("windows")
        else:
            print("iQuant3D-terminal don't support your OS !")
        ...
        if os.name == 'posix':
            ...
            print("windows")
            os.system('move '+self.folder+'\*signal.pdf '+self.folder+'\signal')
        else:
            print("iQuant3D-terminal don't support your OS !")
        ...
        if os.name == 'posix':
            ...
            print("windows")
            os.system('move '+self.folder+'\*mapping.png '+self.folder+'\mapping')
        else:
            print("iQuant3D-terminal don't support your OS !")
